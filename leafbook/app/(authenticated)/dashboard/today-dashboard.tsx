...
const getDashboardProfile = cache((userId: string) => getProfileForUser(userId));
const getDashboardDueTasks = cache((userId: string) => getDueTasksForUser(userId));
const getDashboardPlantCount = cache((userId: string) => getPlantCountForUser(userId));
const getDashboardWishlistCount = cache((userId: string) => getWishlistCountForUser(userId));
const getDashboardJournalEntries = cache((userId: string) =>
  getRecentJournalEntriesForUser(userId)
);
const getDashboardSpotlightPlants = cache((userId: string) =>
  getPlantsForSpotlight(userId)
);
const getDashboardActiveIssueCount = cache((userId: string) =>
  getActiveIssueCountForUser(userId)
);
const getDashboardScheduleSuggestions = cache((userId: string) =>
...
async function ScheduleSuggestionsSection({ userId }: { userId: string }) {
...
async function CareTasksSection({ userId }: { userId: string }) {
...
async function UpcomingWaterSection({ userId }: { userId: string }) {
...
async function SpotlightAndActionsSection({ userId }: { userId: string }) {
...
async function RecentJournalSection({ userId }: { userId: string }) {
...
async function EmptyStateSection({ userId }: { userId: string }) {
...
export function TodayDashboard({ userId }: { userId: string }) {
  if (!userId) {
    return null;
  }
